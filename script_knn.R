#importing function in the other file
#setwd('/home/ladangol/Downloads/Project3')
source('utility_knn.R')
...
#calling the KNN function
  ...
  #builtin knn function
  #------------------------
  #predicted_label <- knn(training_data,test_data,training_label,k=10)
  
  #our knn function
  #-------------------------
#for(kn in 1:round(sqrt(nrow(training_data)))) { # kn is K for knn
  kn = round(sqrt(nrow(training_data)))
        predicted_label <- myknn(training_data,test_data,kn)
      ...
      print(mean(accuracy_values))
      print("average precision")
      print(mean(precision_values))
      print("average recall")
      print(mean(recall_values))
      print("average f1_meansure")
      print(mean(f1_measure_values))
